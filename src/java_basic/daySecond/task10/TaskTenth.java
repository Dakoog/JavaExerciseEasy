package java_basic.daySecond.task10;
...
Przykład
How
many words would you like insert? 3
Kurs
Nerd
Java
Result
...
public class TaskTenth {
    ...
    private static int getNumbersYourWords(){
        Scanner input = new Scanner(System.in);
        return input.nextInt();
    }
//    private static String abbreviationWithLastLetters(){
//        String word = "";
//
////    }
}
